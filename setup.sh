...
echo "  • Chat & Security Inspector:   http://localhost:8000/app/"
echo "  • Telescope & Stress-Lab:      http://localhost:8000/telescope"
echo "  • Architecture Explorer Hub:   http://localhost:8000/architecture"
echo "  • Scalar API Documentation:    http://localhost:8000/docs"
echo ""
echo "Run automated test suite (47 tests):"
echo "  pytest tests/ -v"
echo "================================================================="
